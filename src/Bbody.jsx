...
const Body = () => {
  return (
    <div className="h-[83vh] mb-[6%] mx-[20px] sm:mx-[45px] p-4 sm:p-6 font-mono">
      <div className="flex flex-col justify-center text-left p-2">
        <h2 className="text-3xl sm:text-4xl md:text-6xl text-white font-bold leading-[1.2] max-w-full sm:max-w-[548.359px] my-5">
          Hi, My Name is Ibrahim Abdulquadri Abiodun
        </h2>
        <p className="text-lg sm:text-xl md:text-2xl leading-[1.2] text-[#e0e0e0]">
          A front-end developer.
        </p>
        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 my-7">
          <Link to="/contacts">
            <button
              className="w-full sm:w-auto flex items-center justify-center px-6 py-3 border border-[#9e9e9e] bg-black text-[#e0e0e0] hover:bg-[#9e9e9e] hover:text-black transition duration-300"
            >
              CONTACT ME
            </button>
          </Link>
          <a href="./cv1.pdf" target="_blank" rel="noopener noreferrer" className="w-full sm:w-auto">
            <button
              className="w-full sm:w-auto flex items-center justify-center px-6 py-3 border border-[#9e9e9e] bg-black text-[#e0e0e0] hover:bg-[#9e9e9e] hover:text-black transition duration-300"
            >
              VIEW CV
